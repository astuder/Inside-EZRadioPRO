...
f xreg.modem_rssi_thresh 1  @ xreg_base+0x54
...
CCu 5:cmd busy error 6:cmd busy error if 1 7:clr before parse cmd, set when done  @ xreg_base+0x91
...
f xreg.crc_value_0 1  @ xreg_base+0xbf
CCu only bytes 0-1 used for crc16  @ xreg_base+0xbf

f xreg.crc_value_1 1  @ xreg_base+0xc0
