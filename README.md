...
- [High resolution die shot](https://github.com/astuder/Inside-EZRadioPRO/blob/master/img/Si4362-C2A-top20x-goodspeed.jpg) of the die found in Si4362-C2A courtesy of Travis Goodspeed, unfortuantely with most of the digital section hidden under a metal layer
- The Si4440 die is also [found in the Si1062](http://www.siliconpr0n.org/archive/doku.php?id=infosecdj:silabs:si1602). This die is of the older B1B revision with only minor differences visible compared to C2A.
- The Si4440 C2A die is also [found in the EZR32HG220](https://electronupdate.blogspot.com/2026/04/amazon-blink-gen3-outdoor-camera.html) [(same on YouTube)](https://youtu.be/BPvyd_3hW0g?t=288). This likely applies to all members of the short-lived EZR32 family.
